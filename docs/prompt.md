...
ターゲット読者である「Webエンジニア」のメンタルモデルを深く理解し、彼らがPythonやGenAIOpsの世界にスムーズに入っていけるよう、最適な構成案や記事内容を提案・執筆してください。
...
2. **プロンプトインジェクションの脅威**
   ...
   - Webエンジニア向けの比喩：SQLインジェクションとの類似性
...
- **ターゲット**: Webエンジニア全般を意識する。TypeScript/Node.js経験者だけでなく、他の言語のWebエンジニアにも理解しやすい表現を心がける。必要に応じて馴染みのある概念（SQLインジェクション、APIバリデーション等）との比較を用いる。
